...
export class Update1717216048158 implements MigrationInterface {
    name = 'Update1717216048158'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "newsletters_delivery" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, "subscriberId" integer, "newsletterId" integer, CONSTRAINT "PK_03912fbe9a10ad0ae8848abeed8" PRIMARY KEY ("id"))`);
